...
internal sealed class SoftwareUpdateDialog : Form
{
    ...
    public SoftwareUpdateDialog(IReadOnlyList<SoftwareUpdateInfo> updates)
    {
        ...
        UiFit.FitButton(upgrade, padding: 28);
        ...
        UiFit.FitButton(selectAll, padding: 24);
        ...
        UiFit.FitButton(clear, padding: 24);
        ...
        UiFit.FitButton(close, padding: 24);
        ...
        var btnH = Math.Max(upgrade.Height, Math.Max(selectAll.Height, Math.Max(clear.Height, close.Height)));
    ...
    private void ConfirmUpgrade()
    {
        ...
        {
            MessageBox.Show(this, "请至少勾选一款软件。", Text, MessageBoxButtons.OK, MessageBoxIcon.Information);
            return;
        }

        if (MessageBox.Show(this,
                $"将对 {SelectedUpdates.Count} 款软件执行更新，是否继续？",
