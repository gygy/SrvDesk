...
internal sealed class DnsSwitcherDialog : Form, IEmbeddedSettingsPage
{
    ...
    [
        ...
        ("Cloudflare 恶意软件拦截", "1.1.1.2", "1.0.0.2"),
        ("Cloudflare 家庭（恶意+成人）", "1.1.1.3", "1.0.0.3"),
        ...
        ("AdGuard 家庭", "94.140.14.15", "94.140.15.16"),
        ("Mullvad Base", "194.242.2.2", "194.242.2.3"),
        ("Mullvad Adblock", "194.242.2.9", "194.242.2.9"),
    ];
