...
internal static class ServiceOptimizeLtscHints
{
    ...
    private static readonly Dictionary<string, Hint> ByService =
        new(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["BluetoothUserService"] = new(ServiceRecommend.Disable, "应禁用", "【应禁用】不用蓝牙时强烈推荐关闭；不影响多数 2.4G 无线鼠标"),
            ["BTAGService"] = new(ServiceRecommend.Disable, "应禁用", "【应禁用】不用蓝牙时强烈推荐关闭；不影响多数 2.4G 无线鼠标"),
            ["bthserv"] = new(ServiceRecommend.Disable, "应禁用", "【应禁用】不用蓝牙时强烈推荐关闭；不影响多数 2.4G 无线鼠标"),
            ...
            ["RemoteRegistry"] = new(ServiceRecommend.Disable, "应禁用", "【应禁用】远程注册表；强烈推荐关闭"),
            ...
            ["SysMain"] = new(ServiceRecommend.Disable, "应禁用", "【应禁用】预读占磁盘 I/O，强烈推荐关闭（原 Superfetch）"),
            ["Superfetch"] = new(ServiceRecommend.Disable, "应禁用", "【应禁用】预读占磁盘 I/O，强烈推荐关闭（现名 SysMain）"),
            ...
            ["WSearch"] = new(ServiceRecommend.Disable, "应禁用", "【应禁用】不需要文件索引时强烈推荐关闭，可用 Everything 代替"),
            ["wuauserv"] = new(ServiceRecommend.Disable, "应禁用", "【应禁用】可禁用以避免不必要自动更新；需要打补丁时再开"),
    ...
    private static readonly Dictionary<string, Hint> ByDisplay =
        new(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["Bluetooth Audio Gateway Service"] = new(ServiceRecommend.Disable, "应禁用", "【应禁用】不用蓝牙时强烈推荐关闭；不影响多数 2.4G 无线鼠标"),
            ["Bluetooth Support Service"] = new(ServiceRecommend.Disable, "应禁用", "【应禁用】不用蓝牙时强烈推荐关闭；不影响多数 2.4G 无线鼠标"),
            ["Bluetooth User Support Service"] = new(ServiceRecommend.Disable, "应禁用", "【应禁用】不用蓝牙时强烈推荐关闭；不影响多数 2.4G 无线鼠标"),
            ...
            ["Remote Registry"] = new(ServiceRecommend.Disable, "应禁用", "【应禁用】远程注册表；强烈推荐关闭"),
            ...
            ["Windows Search"] = new(ServiceRecommend.Disable, "应禁用", "【应禁用】不需要文件索引时强烈推荐关闭，可用 Everything 代替"),
            ["索引服务"] = new(ServiceRecommend.Disable, "应禁用", "【应禁用】不需要文件索引时强烈推荐关闭，可用 Everything 代替"),
            ["Indexing Service"] = new(ServiceRecommend.Disable, "应禁用", "【应禁用】不需要文件索引时强烈推荐关闭，可用 Everything 代替"),
            ["Windows Security Service"] = new(ServiceRecommend.Manual, "按需", "【按需】用微软杀毒软件的开着"),
            ["Windows Update"] = new(ServiceRecommend.Disable, "应禁用", "【应禁用】可禁用以避免不必要自动更新；需要打补丁时再开"),
