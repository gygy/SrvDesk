...
internal static class ServiceOptimizeLtscHints
{
    ...
    private static readonly Dictionary<string, Hint> ByService =
        new(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["WSearch"] = new(ServiceRecommend.Disable, "应禁用", "【应禁用】索引占资源较大，强烈推荐关闭，可用 Everything 代替"),
    ...
    private static readonly Dictionary<string, Hint> ByDisplay =
        new(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["Windows Search"] = new(ServiceRecommend.Disable, "应禁用", "【应禁用】索引占资源较大，强烈推荐关闭，可用 Everything 代替"),
            ["索引服务"] = new(ServiceRecommend.Disable, "应禁用", "【应禁用】索引占资源较大，强烈推荐关闭，可用 Everything 代替"),
            ["Indexing Service"] = new(ServiceRecommend.Disable, "应禁用", "【应禁用】索引占资源较大，强烈推荐关闭，可用 Everything 代替"),
