...
当前版本：**1.0.13** · [Releases 下载](https://github.com/gygy/SrvDesk/releases)
...
顶栏可看本机 **IPv4、CPU、内存**。可用搜索框与「分类」筛选；勾选「隐藏不适用项」可收起当前系统不支持的开关。
...
**和 WinUtil / SophiApp 区别？** 更偏向 Server 桌面化：即时页（启动项、DNS、自定义配置）+ Server 相关项，单 exe。  
